...
public class CivilDepartment extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnFaculty.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(getApplicationContext(),CEFacultyLIstView.class);
		...
		btnRoutine.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.putExtra("pdf", "http://www.aust.edu/civil/class_routine_ce.pdf");
				startActivity(intent);
			}
		});
